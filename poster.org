...
# #+BEAMER_HEADER: \usepackage[size=custom,width=33.11,height=46.81,scale=1.0]{beamerposter}
...
#+BEAMER_HEADER: \logoleft{\includegraphics[height=12cm]{figs/jump_qr.png}}
...
*** QR code to this poster
#+ATTR_LATEX: :width 0.4\textwidth
[[file:figs/qr_flashtalk.png]]
...
*** We have also developed WebAssembly-based tools to access the data in multiple ways
